...
it('reads the integrity hash from a manifest when configured', function (): void {
    ...
    config(['ichava.icon-browser.security.sri.enabled' => true]);
    config(['ichava.icon-browser.security.sri.manifest' => $manifest]);
...
it('uses the rel attribute for href-mode renders', function (): void {
    config(['ichava.icon-browser.security.sri.enabled' => false]);
...
it('rejects paths that escape public/ via .. traversal', function (): void {
    config(['ichava.icon-browser.security.sri.enabled' => true]);
    config(['ichava.icon-browser.security.sri.manifest' => null]); // force computeFromDisk
...
it('rejects absolute paths outside the public root', function (): void {
    config(['ichava.icon-browser.security.sri.enabled' => true]);
    config(['ichava.icon-browser.security.sri.manifest' => null]);

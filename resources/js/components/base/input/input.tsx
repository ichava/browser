...
export interface InputBaseProps extends Omit<AriaInputProps, "size"> {
    ...
    /**
     * Accessible name for the password visibility toggle. Supply a translated string;
     * defaults to English.
     */
...
export const InputBase = ({
    ...
    return (
        ...
        >
            ...
            {type === "password" && (
                <AriaButton
                    // Localisable. The design system hardcodes this string, and it is the
                    // only accessible name on the control -- in a translated UI it would
                    // read out in English to a screen-reader user while every label
                    // around it was translated. Vendored components are ours to adjust.
                    aria-label={passwordToggleLabel ?? "Toggle password visibility"}
